    ...
    <div>
          ...
          <div className="grid grid-cols-12 gap-8 items-center">
            <div className="col-span-12 md:col-span-7">
                    ...
                    {i === 0 ? (
                      ...
                      <span
                        style={{
                          ...
                          WebkitTextStroke: `2px ${settings.secondary_color}`,
                        }}
                      >
                        {part}
                      </span>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href={settings.nav_url_campaigns || "#campanhas"}
                  className="brutalist-btn flex items-center gap-2"
                  data-testid="hero-support-btn"
                  style={{ backgroundColor: settings.btn_color, color: settings.btn_text_color }}
                >
                ...
                <a href={settings.nav_url_bio || "#biografia"} className="brutalist-btn-dark flex items-center gap-2">
                  {settings.btn_label_hero_secondary || "Sobre Mateus"}
                </a>
                ...
                {(settings.custom_buttons || [])
                  ...
                  .map((btn, i) => (
                    <a
                      ...
                      style={btn.style === "primary" ? { backgroundColor: settings.btn_color, color: settings.btn_text_color } : {}}
                      data-testid={`hero-custom-btn-${i}`}
                    >
                      {btn.label}
                    </a>
                  ))}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-['Outfit'] font-black text-2xl">
                      R${" "}
                      {campaigns
                        .reduce((s, c) => s + (c.raised_amount || 0), 0)
                  ...
                  <div className="p-6">
                    ...
                    <div className="brutalist-progress mb-2">
                      <div
                        ...
                        style={{
                          width: `${featured.goal_amount > 0 ? Math.min((featured.raised_amount / featured.goal_amount) * 100, 100) : 0}%`,
                        }}
                      />
                    </div>
                    ...
                    <div className="flex justify-between text-sm">
                      <span className="font-bold">
                        R$ {(featured.raised_amount || 0).toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                      </span>
                      <span className="text-zinc-500">
                        meta: R$ {(featured.goal_amount || 0).toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                      </span>
                    </div>
                  </div>
                </Link>
        ...
        <section className="py-16 md:py-24 bg-[var(--site-section-alt,#fafafa)]" data-testid="showcase-section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
              {showcase.map((item, i) => (
                <a key={item.id} href={item.link || "#"} className="brutalist-card overflow-hidden group block" data-testid={`showcase-item-${i}`}>
                  ...
                  {item.title && (
                    <div className="p-3">
                      <p className="font-bold text-sm text-center truncate" style={{ color: settings.text_color }}>
                        {item.title}
                      </p>
                    </div>
                  )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {activeCampaigns.length > 0 ? (
            ...
            <div className="brutalist-card p-12 text-center">
              <p className="font-['Outfit'] font-bold text-xl text-zinc-500 uppercase">Nenhuma campanha ativa no momento</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-8">
              <div className="brutalist-card p-8">
                <p
                  className="text-base md:text-lg text-zinc-700 leading-relaxed first-letter:text-6xl first-letter:font-black first-letter:font-['Outfit'] first-letter:float-left first-letter:mr-3 first-letter:mt-1 first-letter:text-[#FFDE00]"
      ...
      <section className="bg-[var(--site-stats-icon-bg,#FFDE00)] py-24 md:py-32 border-y-2 border-zinc-950" data-testid="newsletter-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {subMsg && (
            <p className="mt-4 font-bold text-sm text-zinc-800" data-testid="newsletter-message">
              {subMsg}
            </p>
          )}
        </div>
