    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="brutalist-card p-8 text-center">
          <p className="font-['Outfit'] font-bold text-xl">Campanha nao encontrada</p>
          <a href="/" className="brutalist-btn inline-block mt-4">Voltar</a>
        </div>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-8">
            ...
            <div className="brutalist-card p-6 md:p-8">
              ...
              <p className="text-zinc-700 leading-relaxed whitespace-pre-wrap" data-testid="campaign-description">
            ...
            <div className="lg:sticky lg:top-24 space-y-6">
              ...
              <div className="brutalist-card p-6" data-testid="campaign-stats">
                ...
                <div className="text-sm text-zinc-500 mb-6">
                  meta de R$ {(campaign.goal_amount || 0).toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <Users size={16} className="text-zinc-500" />
                    <div>
                      <div className="font-bold text-zinc-950">{campaign.backers_count || 0}</div>
                ...
                <div className="mt-4 p-3 bg-zinc-50 border-2 border-zinc-200">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-zinc-500">Taxa da plataforma: 5%</span>
                  </div>
                </div>
              </div>
                ...
                campaign.tiers.map((tier, i) => (
                  <div key={tier.id} className="brutalist-card p-6" data-testid={`tier-card-${i}`}>
                    <div className="flex items-center justify-between mb-3">
                      <span className="font-['Outfit'] font-black text-2xl text-zinc-950">
                        R$ {parseFloat(tier.price).toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                      </span>
                    </div>
                    ...
                    <button
                      ...
                      className="brutalist-btn w-full text-sm"
                      data-testid={`tier-support-btn-${i}`}
                    >
                      {checkoutLoading === tier.id ? "Processando..." : "Apoiar"}
                    </button>
                  </div>
                ))
              ) : (
